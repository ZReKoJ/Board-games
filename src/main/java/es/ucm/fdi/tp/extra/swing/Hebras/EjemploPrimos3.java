package es.ucm.fdi.tp.extra.swing.Hebras;// Ejemplo de uso de sleep(), interrupt() e isInterrupted().
...
public class EjemploPrimos3 {
	public final static int NUM = 4000000;
	public static void main(String[] args) throws InterruptedException {
		...
		HebraPrimos3 hebra4 = new HebraPrimos3("cuatro",3*NUM+1,4*NUM);
		hebra1.start();
		hebra2.start();
		hebra3.start();
		hebra4.start();
