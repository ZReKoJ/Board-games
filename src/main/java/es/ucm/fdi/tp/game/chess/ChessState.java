package es.ucm.fdi.tp.game.chess;

import static es.ucm.fdi.tp.game.chess.ChessBoard.DIM;
import static es.ucm.fdi.tp.game.chess.ChessBoard.empty;
import static es.ucm.fdi.tp.game.chess.ChessBoard.enemy;
import static es.ucm.fdi.tp.game.chess.ChessBoard.sameTurn;
