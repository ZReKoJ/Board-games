 ...
 */
public class ChessAnimationBoard {
    ...
    public ChessAnimationBoard(ChessAnimationBoard other) {
    ...
    public enum Piece {
        ...
        public static char symbolOf(byte p) {
            return valueOf(p).getSymbol(ChessAnimationBoard.black(p));
        }
