...
public class ChessStateTest {
    ...
    public void testEnPassant() {
        ...
        assertTrue("ChessState.WHITE can capture en-passant",
    ...
    public void testCastling() {
        ...
        assertFalse("ChessState.WHITE cannot long-castle while in check",
                c2.validActions(ChessState.WHITE).contains(
                        new ChessAction(ChessState.WHITE, 7, 4, 7, 2,
                                ChessAction.Special.LongCastle)
                ));
        assertFalse("ChessState.WHITE cannot short-castle while in check",
                c2.validActions(ChessState.WHITE).contains(
                        new ChessAction(ChessState.WHITE, 7, 4, 7, 6,
                                ChessAction.Special.ShortCastle)
                ));
        ...
        assertFalse("ChessState.WHITE cannot long-castle through threat",
                c2.validActions(ChessState.WHITE).contains(
                        new ChessAction(ChessState.WHITE, 7, 4, 7, 2,
                                ChessAction.Special.LongCastle)
                ));
    ...
    public void testMovesAvoidCheck() {
        /*
             ...
             . b p p p p p p - 6
             r n . q k b n r - 7
            ChessState.WHITECastle: 3 ChessState.BLACKCastle: 0 ChessState.BLACK to play
         */
        ChessState cs = new ChessState();
    ...
    public void testFoolsMate() {
        ...
        assertTrue("ChessState.WHITE wins", cs.getWinner() == ChessState.WHITE);
    }
